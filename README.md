...
This repositary consists of a pretrained model. The files in the saved_weights folder contains the weights of the trained model. If you would like to use your own data and train the model again, delete the contents of the **saved_wights** and **result** folder before running the code
# Usage:
